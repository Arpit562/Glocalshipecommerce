      ...
      <div className="top-bar">
        <div className="top-bar-content">
          <div className="top-bar-left">
            <span className="top-bar-text">🌟 Free Shipping on Orders Over $50</span>
          </div>
                  ...
                  {isOpen && (
                    ...
                    >
                      <div className="dropdown-grid">
                        {categories.map((category, index) => (
                          <div key={index} className="dropdown-item">
                            ...
                            >
                              <div className="dropdown-icon">{category.icon}</div>
                              <div className="dropdown-content">
                                <span className="dropdown-title">{category.title}</span>
                                {category.subItems && (
                                  <div className="dropdown-subitems">
                                    {category.subItems.slice(0, 3).map((subItem, subIndex) => (
                                      <span key={subIndex} className="dropdown-subitem">
                                        {subItem}
                                      </span>
                                    ))}
                                    {category.subItems.length > 3 && (
                                      <span className="dropdown-more">+{category.subItems.length - 3} more</span>
                                    )}
                                  </div>
                                )}
                              </div>
                      ...
                      <div className="dropdown-footer">
                        ...
                        >
                          View all categories
                          <IoIosArrowForward className="dropdown-footer-arrow" />
                        </Link>
                      </div>
                    </motion.div>
                  )}
            ...
            <div className="action-icons">
              ...
              >
                <div className="icon-wrapper">
                  ...
                  <span className="notification-badge cart-badge">2</span>
                </div>
              </NavLink>
