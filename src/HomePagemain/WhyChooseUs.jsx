...
const WhyChooseUs = () => {
  ...
  return (
    ...
    <section className="relative bg-gradient-to-br from-gray-50 via-white to-gray-100 backdrop-blur-sm py-20 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-6 font-serif leading-tight"
          >
            Why Choose{' '}
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-lg md:text-xl text-gray-600 mt-6 max-w-3xl mx-auto leading-relaxed"
          >
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              {/* Premium Card */}
              <div className="relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 p-8 border border-gray-100 overflow-hidden">
        ...
        >
          <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-amber-200/30">
