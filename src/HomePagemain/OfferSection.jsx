            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-4 h-[400px] sm:h-[500px] md:h-[600px] overflow-hidden rounded-2xl shadow-xl">
                    ...
                    <div className="relative col-span-1 row-span-1 group rounded-xl overflow-hidden shadow-lg border border-gray-200">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-black/60 p-2 text-center">
                            <span className="text-xs sm:text-sm font-semibold text-amber-300">Artisan's Touch</span>
                        </div>
                    </div>
                    ...
                    <div className="relative col-span-1 row-span-1 group rounded-xl overflow-hidden shadow-lg border border-gray-200">
                        ...
                        />
                        <div className="absolute bottom-0 left-0 right-0 bg-black/60 p-2 text-center">
                            <span className="text-xs sm:text-sm font-semibold text-amber-300">Unique Craftsmanship</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6 sm:p-8 flex flex-col justify-center items-center space-y-6 border border-amber-400/50 rounded-2xl bg-white/70 backdrop-blur-sm text-gray-800">
                    <div className="text-center space-y-3">
                        <span className="text-amber-600 font-medium tracking-wide text-sm sm:text-base">FLASH SALE</span>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Summer Collection</h2>
                    ...
                    <div className="w-full">
                        <h3 className="text-base sm:text-lg font-semibold text-amber-600 text-center mb-4">Deal Ends In</h3>
                        <div className="grid grid-cols-4 gap-2 sm:gap-4 text-center">
                            {["Days", "Hours", "Minutes", "Seconds"].map((label, idx) => {
                                ...
                                return (
                                    <div key={label} className="bg-gray-100 p-2 sm:p-4 rounded-lg border border-gray-300">
                                        <p className="text-xs text-gray-600 uppercase tracking-wider mb-1 sm:mb-2">{label}</p>
                    ...
                    <div className="text-center space-y-3 pt-2">
                        <p className="text-sm text-gray-700">
                            <span className="line-through text-gray-500 mr-2">₹16,699.16</span>
